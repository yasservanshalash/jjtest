...
export default function SearchButton() {
  return (
    ...
    // </Paper>
    <form
    className="bg-black flex items-center justify-center lg:w-[auto] m-auto shadow-none rounded-md lg:justify-start"
  >
    {/* <IconButton className="w-[97%] lg:w-[24px] lg:h-[24px] m-auto lg:m-0 bg-[#fa541c] p-2 lg:p-6 rounded-lg lg:mr-2"> */}
    <IconButton style={{backgroundColor: "#000", padding: "8px", transform: "scale(150%)", borderRadius: "5px", position: "relative", right: "7px"}}>
      <SearchIcon sx={{ color: "white" }} />
    </IconButton>
  </form>
  );
